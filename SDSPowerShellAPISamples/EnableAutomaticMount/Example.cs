...
{
	class EnableAutomaticMount
	{
		/// <summary>
		/// This example demonstrates the use of the Enable-SDSDiskAutomaticMount API
		/// </summary>
		...
		static int Main(string[] args)
		{
			...
			try
			{
				...
				using (API api = new API())
				{
					...
					objects = api.Execute(string.Format("Enable-SDSDiskAutomaticMount '{0}'", vboxPath));
					if (objects == null || objects.Length != 1)
						throw new InvalidOperationException("Enable-SDSDiskAutomaticMount");
